...
Scan = scanobject.scanObjectUtils.load_scanobject("../data/7_14_SP10kvionMx8.scan")
pro = Scan.profiles[0]

EB = -1*pro.profileData[:,:,1]

print EB.max()

EB= EB/EB.max()
X = pro.Xposition[120:220]
Xp = pro.Xposition[320:600]
Xp2 = pro.Xposition[600:791]
EB_lp = np.log(EB[320:600,0])
EB_l = np.log(EB[120:220,0])
EB_lp2 = np.log(EB[600:791,0])
...
plt.savefig("10kvDLSun.pdf", format = 'pdf') # can also save as a tif see docstring
plt.show()

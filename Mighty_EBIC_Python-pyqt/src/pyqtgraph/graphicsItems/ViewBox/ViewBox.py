    ...
    * Item coordinate mapping methods
    ...
    def __init__(self, parent=None, border=None, lockAspect=False, enableMouse=True, invertY=False, enableMenu=True, name=None, invertX=False):
        ...
        *name*          (str) Used to register this ViewBox so that it appears
        ...
        self.rbScaleBox.setPen(fn.mkPen((127,255,100), width=1))   #TM changed colors to chartreuse (127,255,0) much better than blue
        self.rbScaleBox.setBrush(fn.mkBrush(127,255,0,100))
    ...
    def mouseClickEvent(self, ev):
        ...
        #Added TM, Making it so we can add ojects to view 

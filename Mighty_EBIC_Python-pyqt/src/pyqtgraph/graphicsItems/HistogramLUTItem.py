...
class HistogramLUTItem(GraphicsWidget):
    ...
    def __init__(self, image=None, fillHistogram=True):
        ...
        self.gradient.setOrientation('right')#TM 'bottom'
        self.gradient.loadPreset('grey')
        self.region = LinearRegionItem([0, 1], LinearRegionItem.Horizontal)
        #TM can set to Vertical as well
        self.region.setZValue(1000)
        self.vb.addItem(self.region)
        #TM commented out got rif of axis
        self.axis = AxisItem('left', linkView=self.vb, maxTickLength=-3, parent=self)
        self.axis.enableAutoSIPrefix()#Turn on SI prefix
        #self.axis.setLabel(units = 'V')#quick test
        #self.axis.setWidth(w = 30)
        ...
        self.plot.rotate(90)
        #TM TODO: this is where we can change oreinetation of HUT

...
class AxisItem(GraphicsWidget):
    ...
    def __init__(self, orientation, pen=None, linkView=None, parent=None, maxTickLength=-3, showValues=True):
        """
        ==============  ===============================================================
        **Arguments:**
        ...
        self.textWidth = 20  ## Keeps track of maximum width / height of tick text 
        self.textHeight = 12
